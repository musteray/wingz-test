...
REST_FRAMEWORK = {
    ...
    # Throttling (optional but recommended)
...
# Logging configuration (helpful for debugging queries)
LOGGING = {
    'version': 1,
    ...
    'loggers': {
        'django.db.backends': {
            'level': 'DEBUG' if os.environ.get("DJANGO_DEBUG") else 'INFO',  # Set to INFO in production
            'handlers': ['console'],
        },
    },
}
